function loadcomplete(){
    ...
    var promise4 =  d3.csv("../static/data/powell_lmkt_x.csv")
    var promise5 =  d3.csv("../static/data/powell_mmkt_x.csv")
    var promise6 =  d3.csv("../static/data/powell_smkt_x.csv")
    ...
    Promise.all(promises).then(data => {
        ...
        // Plotly.newPlot("vizContainer_comb7", [trace7,], layout)//,trace2])
...
function updatechartselect(myseldate) {
    ...
    mydate = new Date(mydate.setDate(mydate.getDate() - 7))
    mydate = mydate.toISOString().split('T')[0]
    d3.csv("../static/data/powell_lmkt_x.csv").then((data) => {
    ...
    d3.json(`/ml/pow/${myseldate}`).then(data =>{   
...
function updatechartselect_mid(myseldate) {
    ...
    mydate = new Date(mydate.setDate(mydate.getDate() - 7))
    mydate = mydate.toISOString().split('T')[0]
    d3.csv("../static/data/powell_mmkt.csv").then((data) => {
    ...
    //   }
    // })
    d3.json(`/ml/pow_mid/${myseldate}`).then(data =>{   
...
function updatechartselect_small(myseldate) {
    ...
    mydate = new Date(mydate.setDate(mydate.getDate() - 7))
    mydate = mydate.toISOString().split('T')[0]
    d3.csv("../static/data/powell_smkt.csv").then((data) => {
    ...
    //   }
    // })
    d3.json(`/ml/pow_small/${myseldate}`).then(data =>{   
